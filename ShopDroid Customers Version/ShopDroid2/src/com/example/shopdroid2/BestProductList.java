...
public class BestProductList extends Activity 
{
		...
		list.setOnItemClickListener(new OnItemClickListener() 
		{
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,long id) 
			{
				...
				if((prefsUsername == null))
				{
					...
					Toast.makeText(BestProductList.this, "Login to Continue.", Toast.LENGTH_SHORT).show();
	...
	public void getData() 
	{
		dialog = ProgressDialog.show(BestProductList.this, "Please wait..", "Getting details..", true, true);
		...
		client.post(url, params, new AsyncHttpResponseHandler() 
		{
			...
			public void onSuccess(String response) 
			{
				...
				try 
				{
					...
					ListAdapter adapter = new SimpleAdapter(BestProductList.this, productList, R.layout.products_list_items, new String[] 
					{ 
