...
public class SearchProductListWithoutLogin extends Activity 
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		list.setOnItemClickListener(new OnItemClickListener() 
		{
			...
			public void onItemClick(AdapterView<?> parent, View view, final int position,long id) 
			{
				...
				dialog1 = new Dialog(SearchProductListWithoutLogin.this);
				...
				btnBestPrice.setOnClickListener(new OnClickListener() 
				{
					...
					{
						Intent i=new Intent(SearchProductListWithoutLogin.this,BestProductListWithoutLogin.class);
				...
				btnBuy.setOnClickListener(new OnClickListener() 
				{
					...
					public void onClick(View v) 
					{
						...
						if((prefsUsername == null))
						{
							...
							Toast.makeText(SearchProductListWithoutLogin.this, "Login to Continue.", Toast.LENGTH_SHORT).show();
						...
						else
						{
							...
							i.putExtra("barcode", TAG_BARCODE);
	...
	public void getData() 
	{
		dialog = ProgressDialog.show(SearchProductListWithoutLogin.this, "Please wait..","Getting details..", true, true);
		RequestParams params = new RequestParams();
		params.add("Keywords", Keywords);
		AsyncHttpClient client = new AsyncHttpClient();
		String url = URL1.searchProducts;
		client.post(url, params, new AsyncHttpResponseHandler() 
		{
			...
			public void onSuccess(String response) 
			{
				...
				try 
				{
					...
					ListAdapter adapter = new SimpleAdapter(SearchProductListWithoutLogin.this,
