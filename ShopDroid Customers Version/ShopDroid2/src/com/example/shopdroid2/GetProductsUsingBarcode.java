...
public class GetProductsUsingBarcode extends Activity
{
	String barcode;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		list.setOnItemClickListener(new OnItemClickListener() 
		{
			...
			public void onItemClick(AdapterView<?> parent, View view, final int position,long id) 
			{
				...
				dialog1 = new Dialog(GetProductsUsingBarcode.this);
				...
				btnBestPrice.setOnClickListener(new OnClickListener() 
				{
					...
					{
						Intent i=new Intent(GetProductsUsingBarcode.this,BestProductListWithoutLogin.class);
				...
				btnBuy.setOnClickListener(new OnClickListener() 
				{
					...
					public void onClick(View v) 
					{
						if((prefsUsername == null))
						{
							...
							Toast.makeText(GetProductsUsingBarcode.this, "Login to Continue.", Toast.LENGTH_SHORT).show();
	...
	public void getData() 
	{
		dialog = ProgressDialog.show(GetProductsUsingBarcode.this, "Please wait..", "Getting details..", true, true);
		...
		client.post(url, params, new AsyncHttpResponseHandler() 
		{
			...
			public void onSuccess(String response) 
			{
				...
				try 
				{
					...
					ListAdapter adapter = new SimpleAdapter(GetProductsUsingBarcode.this,
