...
public class NearestShopsWithoutLogin extends Activity
{
    ...
    public void getData()
    {
    	dialog=ProgressDialog.show(NearestShopsWithoutLogin.this, "Please wait..", "Getting details..",true,true);
		RequestParams params = new RequestParams();
		params.add("longitude", longitude);
		params.add("latitude", latitude);
		AsyncHttpClient client = new AsyncHttpClient();
		String url = URL1.nearestShop1;
			...
			public void onSuccess(String response) 
			{
				...
				try 
				{
		           ...
		           ListAdapter adapter = new SimpleAdapter(
	                NearestShopsWithoutLogin.this, shopList, R.layout.list_item,
	                new String[]
            		{
