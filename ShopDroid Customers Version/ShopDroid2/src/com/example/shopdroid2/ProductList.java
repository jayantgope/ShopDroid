...
public class ProductList extends Activity 
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		list.setOnItemClickListener(new OnItemClickListener() 
		{
			...
			public void onItemClick(AdapterView<?> parent, View view, final int position,long id) 
			{
				...
				dialog1 = new Dialog(ProductList.this);
				...
				btnBestPrice.setOnClickListener(new OnClickListener() 
				{
					...
					{
						Intent i=new Intent(ProductList.this,BestProductList.class);
				...
				btnBuy.setOnClickListener(new OnClickListener() 
				{
					...
					public void onClick(View v) 
					{
						if((prefsUsername == null))
						{
							...
							Toast.makeText(ProductList.this, "Login to Continue.", Toast.LENGTH_SHORT).show();
	...
	public void getData() 
	{
		dialog = ProgressDialog.show(ProductList.this, "Please wait..","Getting details..", true, true);
		...
		client.post(url, params, new AsyncHttpResponseHandler() 
		{
			...
			public void onSuccess(String response) 
			{
				...
				try 
				{
					...
					ListAdapter adapter = new SimpleAdapter(ProductList.this,
